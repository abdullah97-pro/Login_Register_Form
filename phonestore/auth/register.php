<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!preg_match('/^[a-zA-Z0-9_]{3,32}$/',$username)){
            $error_messages[] = "Username must be 3-32 characters long and can only contain letters, numbers, and underscores.";
        }
        // validate email
        ...
        // if there are errors display then
    ...
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../assets/dashboard/assets/img/curved-images/curved14.jpg');">
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" action="./register.php" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="Confirm Password" aria-label="Confirm Password" aria-describedby="password-addon">
                  </div>
                  <div class="form-check form-check-info text-left">
                    <input class="form-check-input" type="checkbox" name="is_admin" id="is_admin">
                    <label class="form-check-label" for="is_admin">
                    I am <a href="javascript:;" class="text-dark font-weight-bolder">Admin</a>
                    </label>
                  </div>
                  <div class="form-check form-check-info text-left">
